            ...
            <v-img class="align-end text-white"
              ...
              <div class="position-absolute" style="top: 8px; right: 8px;">
                <v-menu open-on-hover>
                  ...
                  <v-list>
                    <v-list-item @click="dialog_edit = true; selectedType = 'cat'; selectedId = category.id;  newName = category.name">
...
<script setup lang="ts">
  ...
  import { createSOP, deleteSOP, updateSOP } from '@/services/sopService'
